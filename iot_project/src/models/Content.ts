export default class Content {
	...
	constructor($temperatura: string , $luminosidade: string , $umidade: string , $tempMax: string , $tempMin: string , $umidMax: string , $umidMin: string , $lumMax: string , $lumMin: string , $current_color: string , $status_buzze: string ) {
		...
		this.status_buzze = $status_buzze;
	}
     ...
     * @return {string }
     */
	public get $status_buzze(): string  {
		return this.status_buzze;
	}
     ...
     * @param {string } value
     */
	public set $status_buzze(value: string ) {
		this.status_buzze = value;
	}
